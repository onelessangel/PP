...
-}
-- data StandardGraph a = StandardGraph {nodes :: S.Set a, edges :: S.Set (a, a)} deriving (Show, Eq)
...
-- fromComponents ns es = StandardGraph {nodes = S.fromList ns, edges = S.fromList es}
